...
//   const handleSignUp = () => {
//     navigate("/aboutus"); // Navigate to the signup route
//   };
...
//                 Home
//               </Nav.Link>
//               <Nav.Link href="#action2" className="ms-lg-3 fw-bold text-dark" onClick={handleSignUp}>
//                 About us
//               </Nav.Link>
//               <NavDropdown
//                 title={
//                   <span className="ms-lg-3 fw-bold text-dark text-center">
//                     Cryotherapy
//                   </span>
//                 }
...
function Menu() {
  ...
  const handleNavigate = (path) => {
    setExpanded(false); // Close the menu after navigation
    navigate(path);
  };
        ...
        <Container className="text-center">
          ...
          <Navbar.Collapse id="navbarScroll">
            <Nav className="me-auto my-2 my-lg-0" navbarScroll>
              ...
              <Nav.Link
                className="ms-lg-3 fw-bold text-dark"
              ...
              >
                ...
                <NavDropdown.Item className="text-center">FAQ</NavDropdown.Item>
              </NavDropdown>
              <Nav.Link className="ms-lg-3 fw-bold text-dark">
                Services
              </Nav.Link>
              <Nav.Link className="ms-lg-3 fw-bold text-dark">Benefits</Nav.Link>
              <Nav.Link className="ms-lg-3 fw-bold text-dark">Blog</Nav.Link>
              <Nav.Link className="ms-lg-3 me-lg-5 fw-bold text-dark">
                Reach us
              </Nav.Link>
            </Nav>
          </Navbar.Collapse>
